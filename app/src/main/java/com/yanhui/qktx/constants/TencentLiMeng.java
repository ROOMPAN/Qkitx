...
public class TencentLiMeng {
    public static final String APPID = "1106409332"; //腾讯联盟广告 appid
    ...
    public static final String SplashPosID = "4010928529043690";//腾讯联盟广告 启动页广告
    public static final String NativePosID = "5000709048439488";
    public static final String NativeVideoPosID = "2050206699818455";//腾讯联盟广告 视频页广告
