...
import com.yanhui.qktx.adapter.ChannelAdapter;
import com.yanhui.qktx.business.ItemDragHelperCallBack;
import com.yanhui.qktx.business.OnChannelDragListener;
...
import static com.yanhui.qktx.models.entity.Channel.TYPE_MY_CHANNEL;

/**
 * Created by Administrator on 2017/4/18 0018.
 */

public class ChannelDialogFragment extends DialogFragment implements OnChannelDragListener, View.OnClickListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        icon_collapse.setOnClickListener(this);
        processLogic();
    }
    ...
    private void processLogic() {
        ...
        manager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
            ...
            public int getSpanSize(int position) {
                ...
                return itemViewType == TYPE_MY_CHANNEL || itemViewType == Channel.TYPE_OTHER_CHANNEL ? 1 : 3;
            }
        });
